    ...
    <div className="min-h-screen pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-8 text-white/70 text-lg leading-relaxed">
          ...
          <p>So I built Funparks. One app, 64 parks across 6 continents — real-time wait times, curated food guides, hotel recommendations, interactive maps, and an AI assistant that can answer any park question instantly.</p>
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 py-12 border-y border-white/5">
          {[{v:'64',l:'Parks'},{v:'1,000+',l:'Attractions'},{v:'10',l:'Languages'},{v:'6',l:'Continents'}].map(s=>(
