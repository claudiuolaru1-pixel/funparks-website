                ...
                {list.map(p=>{
                  ...
                  return(
                    <a key={p.id} href={`/parks/${p.id}`}
                      className='park-card' className='park-card' style={{display:'block',background:'white',borderRadius:'16px',overflow:'hidden',border:'2px solid #f0f0f8',textDecoration:'none',boxShadow:'0 2px 8px rgba(0,0,0,0.04)'}}>
