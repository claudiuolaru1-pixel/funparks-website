...
const IOS="https://apps.apple.com/app/funparks-theme-park-guide/id6763944775";
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-white/60 text-lg leading-relaxed mb-10 max-w-md">60+ theme parks worldwide. Free forever — no subscription, no paywalls.</p>
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href={PLAY} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 px-6 py-4 rounded-2xl bg-white text-gray-900 font-bold hover:bg-gray-50 transition-all shadow-xl hover:scale-105">
                <div><div className="text-xs text-gray-400 uppercase tracking-wider mb-0.5">Download on</div><div className="font-black text-sm">🤖 Google Play</div></div>
              </a>
              <a href={IOS} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 px-6 py-4 rounded-2xl bg-white/10 border border-white/20 text-white hover:bg-white/20 transition-all hover:scale-105">
                <div><div className="text-xs text-white/40 uppercase tracking-wider mb-0.5">Download on</div><div className="font-black text-sm">🍎 App Store</div></div>
              </a>
            </div>
            <ul className="space-y-2">
              {["Free forever","60+ parks worldwide and growing","AI assistant included","Works on Android and iOS"].map(x => (
          ...
          <div className="flex flex-col items-center">
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 w-full max-w-sm shadow-2xl">
              ...
              <p className="text-white/20 text-xs text-center mt-5 font-medium">Available on Android 6.0+ and iOS 15+</p>
            </div>
          </div>
        </div>
      </div>
