        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4 mb-8'>
              <a href='#' target='_blank' rel='noopener noreferrer' className='flex items-center gap-4 px-6 py-4 rounded-2xl bg-white text-gray-900 font-bold hover:bg-gray-50 transition-all shadow-xl'>
              ...
              <a href='#' target='_blank' rel='noopener noreferrer' className='flex items-center gap-4 px-6 py-4 rounded-2xl bg-white/10 border border-white/20 text-white hover:bg-white/20 transition-all'>
